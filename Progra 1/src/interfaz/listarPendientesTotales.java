 ...
 * @author erick
 */
public class listarPendientesTotales extends javax.swing.JFrame {

    /**
     * Creates new form listarPendientesTotales
     */
    public listarPendientesTotales() {
        initComponents();
    }
    public void close(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detalle de artículos pendientes de retirar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listarPendientesTotales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listarPendientesTotales().setVisible(true);
            }
        });
    }
